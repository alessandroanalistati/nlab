...
def equipamentos_aulapraticas(request, aulapratica_id ):
    aulapratica = AulaPratica.objects.get(id=aulapratica_id)      
    if request.method == "POST":               
        form_equipamentosaulapratica = equipamentosaulapratica_forms.EquipamentosAulaPraticaForm(request.POST)      
        ...
        equipamentosaulapratica_novo = equipamentosaulapratica.EquipamentosAulaPratica(usuario=request.user, aulapratica_id=aulapratica.id, equipamentos=equipamentos, quant_equipamentos=quant_equipamentos)                       
    
        equipamentosaulapratica_service.cadastrar_equipamentosAulaPratica(equipamentosaulapratica_novo)       
...
def solucoes_aulapraticas(request, aulapratica_id ):
    aulapratica = AulaPratica.objects.get(id=aulapratica_id)      
    if request.method == "POST":               
        form_solucaoaulapratica = solucaoaulapratica_forms.SolucaoAulaPraticaForm(request.POST)        
        ...
        solucaoaulapratica_novo = solucaoaulapratica.SolucaoAulaPratica(usuario=request.user, aulapratica_id=aulapratica.id, solucao=solucao, quant_solucao=quant_solucao)                       
             
        solucaoaulapratica_service.cadastrar_solucaoaulapratica(solucaoaulapratica_novo)       
...
def pega_ultima_solucao(request):
    ...
    equipamentosaulapratica = EquipamentosAulaPratica.objects.filter(aulapratica_id=ultimo_id_solucao.pk)   
    solucaoaulapratica = SolucaoAulaPratica.objects.filter(aulapratica_id=id)  
    return render(request, 'aulapraticas/visualizar.html', {'aulapratica': aulapratica, 'itensaulapratica' : itensaulapratica, 'equipamentosaulapratica' : equipamentosaulapratica,
        'solucaoaulapratica' : solucaoaulapratica})     
