...
class ItensPedidoSolucao(models.Model): 
    ...
    unidade = models.ForeignKey(Unidade, on_delete=models.PROTECT, related_name='Iten_Psolucao_unidade')  
...
class Solucao(models.Model):
    ...
    sala = models.ForeignKey(Sala, on_delete=models.PROTECT, null=False, related_name='Soluçãos_Sala')
...
class AulaPratica(models.Model):
    ...
    data_inicio =  models.DateTimeField(default=timezone.now, verbose_name="Aula_Pratica_data_inicio :")
    data_fim =  models.DateTimeField(default=timezone.now, verbose_name="Aula_Pratica_Data_Fim :")
    quantalunos = models.IntegerField(null=True, blank=True)       
    obs = models.TextField(verbose_name="Aula_Pratica     ario Observação", null=True, blank=True) 
    status = models.CharField(
        default="Aula Solicitada", null=True, blank=True, verbose_name="Aula_Pratica_status :",
        max_length=15,
        choices=(
...
class ItensAulaPratica(models.Model): 
    ...
    reagente = models.ForeignKey(Reagente, on_delete=models.PROTECT, null=True, blank=True, related_name='Aula_Pratica_reagente') 
    unidade = models.ForeignKey(Unidade, on_delete=models.PROTECT, null=True, blank=True, related_name='Aula_Pratica_unidade')  
    quant_reagente = models.DecimalField(max_digits=9, decimal_places=2, default=0.00, null=True, blank=True, verbose_name='Quant_Aula_Pratica_Reagente')
...
class EquipamentosAulaPratica(models.Model): 
    usuario = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Usuario_Aula_Pratica')    
    aulapratica_id = models.IntegerField(null=True, blank=True)  
    equipamentos = models.ForeignKey(Equipamento, on_delete=models.PROTECT, null=True, blank=True, related_name='Aula_Pratica_Equipamentos') 
    quant_equipamentos = models.DecimalField(max_digits=9, decimal_places=2, default=0.00, null=True, blank=True, verbose_name='Quant_Aula_Pratica_Equipamentos' )
...
class SolucaoAulaPratica(models.Model): 
    usuario = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Usuario_Aula_Pratica')    
    aulapratica_id = models.IntegerField(null=True, blank=True)  
    solucao = models.ForeignKey(Solucao, on_delete=models.PROTECT, null=True, blank=True, related_name='Aula_Pratica_Solução') 
    quant_solucao = models.DecimalField(max_digits=9, decimal_places=2, default=0.00, null=True, blank=True, verbose_name='Quant_Aula_Pratica_Solucão' )
